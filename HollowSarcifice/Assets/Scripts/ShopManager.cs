...
//     int repSum = 0;
//     var soldItems = new List<DragDrop>();
//     string chosenNode = null; //node to go to after sale
...
//         //Look up preferences for this specific NPC
//     var npc = owner != null ? owner.GetComponent<CharacterManager>() : null;
//     if (npc != null){
//           //item = slot.CurrentItem;
//         //Access active profile on the manager
//         var profileField = typeof(CharacterManager)
//             .GetField("currentNPC", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
//         var profile = (NPCProfile)profileField?.GetValue(owner);

//         if (profile != null && item.itemSO !=null && profile.TryGetPref(item.itemSO.category, out var pref)){
//             repSum += pref.repDelta;
